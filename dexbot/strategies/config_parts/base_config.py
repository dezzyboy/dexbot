    ...
    def configure(cls, return_base_config=True):
        ...
        base_config = [
            ConfigElement('account', 'string', '', 'Account',
                          ...
                          ''),
            ConfigElement('market', 'string', 'X4T/USD', 'Market',
                          'BitShares market to operate on, in the format QUOTE/BASE, for example \"X4T/USD\"',
                          r'[A-Z0-9\.]+[:\/][A-Z0-9\.]+'),
            ConfigElement('fee_asset', 'string', 'X4T', 'Fee asset',
